...
public class calculus {
    ...
    public String derivative(String equation) {
        String[] eq = dissectEquation(equation);
        String ret = "dy = ";
        if (eq[3].equals("x")) {
            // linear or quad
            if (eq[4].equals("^")) {
                // quad
                ret+=(Integer.parseInt(eq[5]))+"x"+"dx";
                return ret;
            }
            else {
                // linear
                ret+=(Integer.parseInt(eq[2]))+"dx";
                return ret;
            }
        }
        else {
            ...
            if (eq[3].equals("/")) {
                //inv
                ret+=(Integer.parseInt(eq[2]))+"ln(x)"+"dx";
                return ret;
            }
            else {
                //exp
                ret+="ln("+(Integer.parseInt(eq[2]))+")*"+(Integer.parseInt(eq[2]))+"^x"+"dx";
                return ret;
            }
        }
    }
